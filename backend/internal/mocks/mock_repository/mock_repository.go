...
func (m *MockRepository) CreateUser(ctx context.Context, user entities1.User) error {
	m.ctrl.T.Helper()
...
// CreateUser mocks base method.
func (m *MockUserRepository) CreateUser(ctx context.Context, user entities1.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateUser", ctx, user)
	ret0, _ := ret[0].(error)
	return ret0
